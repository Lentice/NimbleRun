...
- 預設寬度 640 DIP、高度 520 DIP，讓空白查詢狀態完整容納 6 欄 × 4 列。面板高度上限為目前螢幕工作區高度減 32px（work-32px 邊距）；完整 520 DIP 面板放不下時（小螢幕＋高 DPI），footer 提示帶恆貼齊面板底緣保持完整可見，改以縮減清單／格狀的可見列數容納，列高、格高、48 DIP footer 高度與面板寬度皆不變。
